...
adapterRegistry.register('http', (
    { port, privateKeyFileName, certFileName, thresholdForFutureMessageSeconds },
    ...
    app.use('/api/v1', dataProduceEndpoints(streamFetcher, publisher, thresholdForFutureMessageSeconds))
