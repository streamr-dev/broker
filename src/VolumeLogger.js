...
module.exports = class VolumeLogger {
    ...
    async reportAndReset() {
        ...
        console.log(
            ...
            formatNumber(networkMetrics.mainMetrics.msgInSpeed / 1000),
            formatNumber(networkMetrics.mainMetrics.inSpeed / 1000),
            formatNumber(networkMetrics.mainMetrics.msgOutSpeed / 1000),
            formatNumber(networkMetrics.mainMetrics.outSpeed / 1000),
